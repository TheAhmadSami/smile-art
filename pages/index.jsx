...
import { Header, FacebookFeed } from "@sa/components";
    ...
    <div className="body-content">
      ...
      <div id="ceo-voice">
        <div className="_ceo-voice_">
          ...
          <p className="text">
            ...
            colleagues and partners – and all who participated in building this
            entity - you are the owners of this achievement. You have achieved
            something you have to be proud of it. Your company, which began in
            1986 as a modest and small entity, now became one of the important
            sites that serves this nation and its government sites with the best
            services in the field of information technology. I say to our
            customers - who represent most of the information centers in various
            government sites - we are with you and we look forward for the best
            to our country. We renew the covenant and the promise to earn your
            trust. God bless us all.
            <span>
      ...
      <section id="services">
        ...
        <div className="services-container">
          ...
          <div className="services-item">
            ...
            <p className="service-desc">
              To achieve absolute client satisfaction through effective delivery
              of high quality, and to meet the commercial reality in the
              workplace.
            </p>
          </div>
          {/* ITEM END ||||||||||||||||||||||||| */}
      ...
      <section id="products">
        ...
        <div className="image-access categories-controls flex-center">
          <button data-filter=".image-access.flatbed">Flatbed Scanners</button>
          <button data-filter=".image-access.wide">Wide Format Scanners</button>
        ...
        <div className="crowley categories-controls flex-center">
          ...
          <button data-filter=".crowley.microfiche">Microfiche Scanners</button>
        ...
        <div className="indus categories-controls flex-center">
          ...
          <button data-filter=".indus.microfilm-reader">Archive Writer</button>
        ...
        <div className="products-container flex-center">
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <br />• Color @ 200dpi, A4 [Simplex : 45 ppm ,Duplex : 90 ipm]
                </p>
              </div>
            </a>
          </div>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <br />• Color @ 200dpi, A4 Simplex : 60 ppm ,Duplex : 120 ipm
                </p>
              </div>
            </a>
          </div>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <br />• Color @ 200dpi, A4 Simplex : 70 ppm ,Duplex : 140 ipm
                </p>
              </div>
            </a>
          </div>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  <span>Size:</span> A4
                  <br />
                  <span>Optical Resolution (dpi):</span> 75, 100, 150, 200, 240,
                  250, 300, 400, 600, 1200 dpi
                  <br />
                  <span>ADF Capacity:</span> 100 sheets
                  <br />
                  <span>Scanning Speed:</span>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <span>ADF Capacity:</span> 80 Sheets
                  <br />
                  <span>Scanning Speed:</span> Simplex: 60 ppm, Duplex: 120 ipm
                </p>
              </div>
            </a>
          </div>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <span>ADF Capacity:</span> 80 Sheets
                  <br />
                  <span>Scanning Speed:</span> Simplex: Simplex: 40 ppm, Duplex:
                  80 ipm
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <span>ADF Capacity:</span> 80 Sheets
                  <br />
                  <span>Scanning Speed:</span> Simplex: 80 ppm, Duplex: 160 ipm
                </p>
              </div>
            </a>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  <span>Size:</span> A3, A4, A5, A6, B5, B6, Business Card, Post
                  Card, Letter, Double Letter, Legal and Custom Size
                  <br />
                  <span>Optical Resolution (dpi):</span> 600
                  <br />
                  <span>Expected Daily Volume*6:</span> 100,000 sheets
                  <br />
                  <span>Scanning Speed:</span> Simplex: 110 ppm, Duplex 220 ipm{" "}
                </p>
              </div>
            </a>
          </div>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <br />
                  <span>Scanning Speed:</span> Simplex: 100 ppm, Duplex: 200 ipm
                </p>
              </div>
            </a>
          </div>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <br />
                  <span>Scanning Speed:</span> Simplex: 85 ppm, Duplex: 170 ipm
                </p>
              </div>
            </a>
          </div>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <span>ADF Capacity:</span> 500 Sheets
                  <br />
                  <span>Scanning Speed:</span> Simplex: 105 ppm, Duplex: 210 ipm
                </p>
              </div>
            </a>
          </div>
          ...
          >
            ...
            >
              ...
              <div
                className="product-image"
                style={{
                  backgroundImage: "url(products/image-access/WideTEK-12.jpg)",
                }}
              />
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  than scanning area
                  <br />
                  <span>Scanning Speed:</span> A3+ scan of full document bed in
                  less than 3 seconds
                </p>
              </div>
            </a>
          ...
          >
            ...
            >
              ...
              <div
                className="product-image"
                style={{
                  backgroundImage: "url(products/image-access/WideTEK-25.jpg)",
                }}
              />
              <div className="bottom">
          ...
          >
            ...
            >
              ...
              <div
                className="product-image"
                style={{
                  backgroundImage: "url(products/image-access/WideTEK-36.jpg)",
                }}
              />
              <div className="bottom">
          ...
          >
            ...
            >
              ...
              <div
                className="product-image"
                style={{
                  backgroundImage: "url(products/image-access/WideTEK-44.jpg)",
                }}
              />
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <span>Resolution:</span> 1200 x 1200 dpi scanner resolution
                  <br />
                  <span>Scanning Speed:</span> 200 dpi - 17 m/min (11.2 inch/s)
                </p>
              </div>
            </a>
          </div>
          ...
          >
            ...
            >
              ...
              <div
                className="product-image"
                style={{
                  backgroundImage: "url(products/image-access/WideTEK-48.jpg)",
                }}
              />
              <div className="bottom">
          ...
          >
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  <span>Size:</span> Scans fine art or other material 914 x 1524
                  mm / 36 x 60 inches wide or 914 x 2224 mm / 36 x 87.6 inches
                  wide, with optional scan table extension
                  <br />
                  <span>Resolution:</span> 600 x 600 dpi scanner resolution
                </p>
              </div>
          ...
          >
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  <span>Size:</span> The MACH Mini has the smallest footprint in
                  ...
                  <br />
                  <span>Production:</span> The MACH Mini’s included external PC
                  ensures that downtime due to computer malfunctions is kept to
                  a bare minimum.
                </p>
              </div>
            </a>
          ...
          >
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  Scans all standard aperture card and fiche types including COM
                  and jacket Up to 600 dpi true optical resolution
                  <br />
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  <br />
                  <span>Features:</span> touchscreen; manual and motorized roll
                  film pods; smart edit; opaque microcard LED; annotation; timed
                  auto-capture for film and fiche.
                </p>
              </div>
            </a>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  On-demand scanning of single aperture cards at speeds of up to
                  10 seconds/scan.
                  <br />
          ...
          {/* ITEM END ||||||||||||||||||||||||| */}
          {/* ITEM START ||||||||||||||||||||||||| */}
          <div className="addmen mix product-item" style={{ display: "none" }}>
            <a
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  A complete array of integrated software solutions for test and
                  assessment needs OMR Answer Sheet Checker, MCQ Test Scoring,
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  per hour and a fixed, automatic feed hopper holds 100 sheets.
                  Scanner self-diagnostics quickly pinpoint any operating
                  problems.
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  Automatic feed up to 750 forms -- Open feed path design -- Two
                  output stackers holding 750 and 200 forms.
                  <br />
                  OpScan 8 includes an auxiliary output tray for sorting
                  documents that fail user-defined edits -- Processor controlled
                  picker and multiple sheet detector.
                </p>
              </div>
            </a>
          </div>
          ...
          >
            ...
            >
              ...
              <div
                className="product-image"
                style={{
                  backgroundImage: "url(products/scantron/Scantron-Score.jpg)",
                }}
              />
              <div className="bottom">
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  with the SelfScore option let you score tests and quizzes-and
                  see the feedback immediately. Score up to 36 tests per minute,
                  using any of a wide selection of answer sheet forms designed
          ...
          >
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  Small size measures 5.5 by 5.5, Handles forms 3.25 by between
                  3.25 and 14 Accommodates 25 to 30 hand fed forms per minute
                  <br />
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  has a form throughput rate of up to 2,800 sheets-per-hour and
                  a fixed, automatic feed hopper that holds 100 sheets.
                  <br />
                  Read traditional OMR bubble marks.
                  <br />
                  Capture image clips of text areas or text boxes, such as essay
                  responses on a test or comment fields on a survey. Capture
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  OMR with Image
                  <br />
                  Single dual-sided read-head scans optical mark read (OMR) and
                  color image scanning in a single pass.
                  <br />
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  and includes a PC controller as an integral component, making
                  it an affordable choice for projects that require capturing
                  both traditional OMR (optical mark read) data and image data.
                </p>
              </div>
            </a>
          </div>
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  OMR with Image
                  <br />
                  provides OMR form and black-and-white image scanning at up to
          ...
          >
            ...
            >
              ...
              <div
                className="product-image"
                style={{
                  backgroundImage: "url(products/scantron/scan-tools-plus.jpg)",
                }}
              ></div>
              <div className="bottom">
                <p className="product-name">ScanTools® Plus</p>
                <p className="product-desc">
                  Capture both OMR data and image data on one pass through your
                  Scantron image scanner.
                  <br />
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  ...
                  robust recognition engine reads most common Scantron forms and
                  transforms marks into usable data.
                </p>
              </div>
            </a>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="bottom">
                ...
                <p className="product-desc">
                  <span>Size:</span> A3/A4 A1050x650x640 mm, Weight: 85 - 95 kg
                  <br />
          ...
          >
            ...
            >
              ...
              <div
                className="product-image"
                style={{
                  backgroundImage: "url(products/indus/book-scanner-9000.jpg)",
                }}
              />
              <div className="bottom">
          ...
          <div className="top-clients">
            <div className="client-item swiper-slide">
              <div
                ...
                style={{
                  backgroundImage: "url(clients/top-clients/alex-library.svg)",
                }}
              />
            </div>
            <div className="client-item swiper-slide">
      ...
      <section id="projects">
        <div className="left-side">
          ...
          <div className="projects-item">
            <p className="location">Cairo, Egypt</p>
            <p className="c-name">
              The Ministry of Environment Through the Ministry of Communications
        ...
        <div className="right-side">
          <div className="projects-item">
            <p className="location">Cairo, Egypt</p>
            <p className="c-name">Public Prosecution (Prosecution of Egypt)</p>
            ...
            >
              <div className="ni-content">
                <p className="ni-desc">
                  ...
                  formats: PDF, PDF/A, JPEG, TIFF, PNM, multipage PDF and TIFF,
                  DICOM and many more.
                </p>
              </div>
            </div>
          ...
          <div className="right-side">
            ...
            <div className="input-container reciver">
              ...
              <select id="contact_receive">
                ...
                <option value="support@alola-eg.com">Technical Support</option>
